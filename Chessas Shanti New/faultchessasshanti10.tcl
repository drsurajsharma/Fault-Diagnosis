...
$ns at 0.2 "[$node_(1) set ragent_] startfn"
$ns at 0.5 "[$node_(1) set ragent_] startft"
...
#$ns at 30.0 "[$node_(1) set ragent_] startlcd"
#$ns at 30.0 "[$node_(2) set ragent_] startlcd"
#$ns at 30.0 "[$node_(3) set ragent_] startlcd"
#$ns at 30.0 "[$node_(4) set ragent_] startlcd"
#$ns at 30.0 "[$node_(5) set ragent_] startlcd"
#$ns at 30.0 "[$node_(6) set ragent_] startlcd"
#$ns at 30.0 "[$node_(7) set ragent_] startlcd"
#$ns at 30.0 "[$node_(8) set ragent_] startlcd"
#$ns at 30.0 "[$node_(9) set ragent_] startlcd"
#$ns at 30.0 "[$node_(10) set ragent_] startlcd"
